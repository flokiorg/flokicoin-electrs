...
* Update rust-flokicoin to 0.14
* Optimize block headers processing during startup


# 0.3.1 (20 Aug 2018)

* Reconnect to flokicoind only on transient errors
...
* Handle disconnections from flokicoind by retrying
...
* Allow specifying custom flokicoind data directory
...
* Announcement: https://lists.linuxfoundation.org/pipermail/flokicoin-dev/2018-July/016190.html
